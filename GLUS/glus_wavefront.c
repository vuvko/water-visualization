...
#define GLUS_MAX_ATTRIBUTES (8192)
#define GLUS_MAX_TRIANGLE_ATTRIBUTES (32768)
#define GLUS_BUFFERSIZE 256

static GLUSboolean glusCopyObjData(GLUSshape* shape, GLUSuint totalNumberVertices, GLUSfloat* triangleVertices, GLUSuint totalNumberNormals, GLUSfloat* triangleNormals, GLUSuint totalNumberTexCoords, GLUSfloat* triangleTexCoords)
{
